...
import { idlFactory } from './kismi.did.js';
export { idlFactory } from './kismi.did.js';
// CANISTER_ID is replaced by webpack based on node environment
export const canisterId = process.env.KISMI_CANISTER_ID;
 ...
 * @return {import("@dfinity/agent").ActorSubclass<import("./kismi.did.js")._SERVICE>}
 */
...
/**
 * A ready-to-use agent for the kismi canister
 * @type {import("@dfinity/agent").ActorSubclass<import("./kismi.did.js")._SERVICE>}
 */
export const kismi = createActor(canisterId);
