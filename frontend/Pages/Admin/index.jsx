...
function User({setModal, setModalMsg, setFileLoader, kisses, profile, setIsLoading, isLoading, caller, reLoad }) {
  ...
  return (
    <div className="addCards">
      {!isLoading && (<NewContest setModal={setModal} setModalMsg={setModalMsg} kisses={kisses} caller={caller} profile={profile} setIsLoading={setIsLoading} loading={isLoading} setFileLoader={setFileLoader} />)}
